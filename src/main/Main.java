        ...
        try {
            ...
            if (elements != null) {
                for (int i = 0; i < elements.size(); i++) {
                    ...
                    linksToParsing.add(Config.ROOT_DOMAIN + e.attr("href"));
                }
